...
<script>
  ...
  $('.help-icon').click(function() {
    ...
    $(document).on('click', "#product-add-button", function() {
        ...
        var request = $.ajax({
            url: "{{route('user.purchasing.product.cart')}}",
            method: "POST",
            headers: {
    ...
    $(document).on('click', ".ni-create-new-item", function(e) {
        let url = "{{route('user.purchasing.create.item')}}";
    ...
    $(document).on('click', ".edit-cart", function(e) {
        ...
        $.ajax({
            url: "{{ route('user.purchasing.cart.edit') }}",
            method: "GET",
            data: {
                _token: '{{ csrf_token() }}',
    ...
    $(document).on('click', "#product-update-button", function() {
        ...
        // Running Reciever adding ajax request
        var request = $.ajax({
            url: "{{route('user.purchasing.update.cart')}}",
            method: "POST",
            headers: {
                'X-CSRF-TOKEN': "{{csrf_token()}}"
            },
    ...
    $(document).on('blur', "#name", function() {
        ...
        if (site_url) {
            ...
            var request = $.ajax({
                url: "{{route('user.purchasing.url.content')}}",
                method: "POST",
                headers: {
                    'X-CSRF-TOKEN': "{{csrf_token()}}"
                },
    ...
    $(document).on('click', ".remove-from-cart", function() {
        var ele = $(this);
        var url = "{{route('user.purchasing.remove.from.cart')}}";
    ...
    $(document).on('click', "#checkout-button", function() {
        ...
        // Running Reciever adding ajax request
        var request = $.ajax({
            url: "{{route('user.purchasing.product.checkout')}}",
            method: "POST",
            headers: {
                'X-CSRF-TOKEN': "{{csrf_token()}}"
            },
