...
<head>
    ...
    <title>Tracking - {{$order->code ?? 'N/A'}}</title>
        ...
        <div class="">
            <div class="row">
                <div class="confirm-payment" style="padding: 15px 25px; border: 1px solid #eeeeee; margin-bottom: 30px; width: 100%; 
                    ...
                    <p>Your order has been received and it's been processed. We have sent you a confirmation message with a copy of your receipt to the mail address you provided.</p><p>Your order will be delivered to the address you provided by our courier partners. You will receive shipping details when we ship your order.</p>                        
                    ...
                    <table class="table confirm-table1 table-striped" style="text-align: center; margin-bottom: 40px; width: 100%;" width="100%" align="center"> 
                        ...
                        <tbody> 
                            <tr> 
                                <td class="confirm-table1-order" style="font-weight: bold; color: #580000; font-size: 15px;">{{$order->code ?? 'N/A'}}</td>
                                ...
                                <td>{{$order->paymentStatus->slug == 'paid' ? 'Paid' : 'UnPaid'}}</td> 
                            </tr>                   
                        </tbody>
                    </table>
                    ...
                    <table class="table confirm-table2 table-hover table-bordered" style="text-align: center; margin-bottom: 40px; 
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="2" class="text-minimize" style="text-align: left;">{{$purchase->website ?? 'N/A'}}</td>
                                <td colspan="2" class="text-minimize" style="text-align: left;">{{$purchase->name ?? 'N/A'}}</td>
                                <td colspan="2" style="text-align: left;">
                                    <img src="{{$purchase->image_url}}" alt="" width="40px">
                                </td>
                                <td colspan="" style="text-align: left;">{{$purchase->size ?? 'N/A'}}</td>
                                <td colspan="" style="text-align: left;">{{$purchase->quantity ?? 'N/A'}}</td>
                                <td colspan="" style="text-align: left;">{{$purchase->currency->symbol ?? 'N/A'}} {{$purchase->price ?? 'N/A'}}</td>
                            </tr>
                            @endforeach

                            <tr>
                                <td colspan="8" class="text-right text-black-70 pd-20">
