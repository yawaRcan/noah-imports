    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
              <strong>Alert!</strong> Please pay your amount due ƒ {{$orderAmountDue}} ANG
                ...
                <div class="border-bottom title-part-padding">
                    <div class="row">
                        ...
                        <div class="col-6 text-end">
                            <a href="{{route('user.purchasing.create')}}" class="btn btn-light-info text-info font-weight-medium waves-effect">Create Order</a>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function table(params = null) {
       var config ="{{$status}}";
        ...
        table = $('.data-table').DataTable({
            ...
            destroy: true,
            stateSave: true,
            ajax: "{{route('user.purchasing.order.data')}}?status="+config,
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex'
                },
    ...
    $(document).on('click', ".ni-payment-show-modal", function() {
        ...
        let url = "{{route('user.purchasing.getPaymentHtml',['id' => ':id'])}}";
