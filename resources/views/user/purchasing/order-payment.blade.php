...
<script>
    ...
    $(document).on('click', ".billing-data-add", function() {
        ...
        let url = "{{route('user.purchasing.charge.create',['id' => ':id'])}}";
    ...
    $(document).on('click', "#billing-add-button", function() {
        ...
        let url = "{{route('user.purchasing.charge.store')}}";
    ...
    $(document).on('click', ".billing-data-edit", function() {
        ...
        let url = "{{route('user.purchasing.charge.edit',['id' => ':id'])}}";
        url = url.replace(':id', id);
    ...
    $(document).on('click', "#billing-edit-button", function() {
        ...
        let id = $(this).data("billing-id");
        let url = "{{route('user.purchasing.charge.update',['id' => ':id'])}}";
        url = url.replace(':id', id);
    ...
    $(document).on('click', ".billing-data-delete", function() {
        let id = $(this).data("billing-id");
        let url = "{{route('user.purchasing.charge.delete',['id' => ':id'])}}";
        url = url.replace(':id', id);
        deleteAjax(url, null)
    })
    ...
    $(document).on('click', ".ni-payment-show-modal", function() {
        let id = $(this).data("billing-id");
        let url = "{{route('user.purchasing.getChargePaymentHtml',['id' => ':id'])}}";
        url = url.replace(':id', id);
