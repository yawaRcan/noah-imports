                ...
                <div class="card-body">
                    <div class="d-flex no-block align-items-center">
                        ...
                        <div class="ms-3 mt-2">
                            ...
                            @if($user->balance() < 0) <h5 class="" style="color: #FF0000;">ƒ {{$user->balance()}} ANG</h5>
                                @else
                ...
                <div class="card-body">
                    <div class="d-flex no-block align-items-center">
                        ...
                        <div class="ms-3 mt-2">
                            ...
                            <h5 class="text-white">ƒ {{$user->credit()}} ANG</h5>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex no-block align-items-center">
                        ...
                        <div class="ms-3 mt-2">
                            ...
                            <h5 class="text-white">ƒ {{$user->debit()}} ANG</h5>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="scrollable-content">
                                 <table class="table table-bordered table-condensed">
                                        ...
                                        <tr>
                                            ...
                                            <td> <p class="card-text">{{$branch->name ?? 'N/A'}} {{$branch->last_name ?? 'N/A'}} / {{\Auth::guard('web')->user()->customer_no}}</p></td>
                                        </tr>
                                        <tr>
                    ...
                    <a href="{{route('user.wallet.index')}}" target="_blank">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row mt-4">
                                    <div class="col-7">
                                        <span class="display-7 text-primary">ƒ {{$data['approved_transactions']}} ANG</span>
                    ...
                    <div class="card">
                        <a href="{{route('user.parcel.index')}}" target="_blank">
                            <div class="card-body">
                                ...
                                <div class="row mt-4">
                                    <div class="col-7">
                                        <span class="display-7 text-success">ƒ {{$data['payment_recieved']}} ANG</span>
                                        <!--   <h6 class="text-muted">10% Increased</h6>
                                                <h5 class="text-nowrap">(150-165 Sales)</h5> -->
                                    </div>
                                    <div class="col-5">
                                ...
                                <tbody>
                                    @forelse($data['latest_orders'] as $order)
                                        <tr>
                                            ...
                                            <td>{{$order->shipperAddress->name}} - {{$order->shipperAddress->country->name}}</td>
