                            ...
                            <div class="p-3 text-start">
                                <form class="form-horizontal" id="privacy-edit-form" action="javascript:void(0)" enctype="multipart/form-data"> 
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-3">
                                            @if(isset($user->image))
                                                <div class="text-center p-3 img-round"><img class="nl-exship-file-edit-preview" src="{{asset('storage/assets/user-profile')}}/{{$user->image}}" width="100" height="100"/></div>
                                            @endif
...
<script>
    ...
    $(document).on('click', "#user-edit-button", function() {
        ...
        let url = "{{route('user.account.privacy.update',['id' => ':id'])}}";
    ...
    $(document).on('click', "#password-edit-button", function() {
        let id = $(this).data("user-id");
        let url = "{{route('user.account.password.update',['id' => ':id'])}}";
        url = url.replace(':id', id);
