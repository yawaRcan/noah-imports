                ...
                <div class="row card-body">
                    <div class="col-md-8">
                        <form class="form-horizontal" action="javascript:void(0)" id="account-update-form">
                            ...
                            <label for="tb-rfname">Customer No</label>
                            <div class="input-group mb-3">
                                <span class="input-group-text fa fa-user"></span>
                                <input id="customer_no" class="form-control" type="text" name="customer_no" value="{{$user->customer_no}}" required autocomplete="customer_no" readonly />
                            </div>
                            <label for="tb-rfname">Username</label>
                            <div class="input-group mb-3">
                                <span class="input-group-text fa fa-user"></span>
                                <input id="name" class="form-control" type="text" name="username" value="{{$user->username}}" required autocomplete="username" readonly />
                            </div>
                            <label for="tb-rfname">Company</label>
                            <div class="input-group mb-3">
                                <span class="input-group-text fa fa-building"></span>
                                <input id="company" class="form-control" type="text" name="company" value="{{$user->company}}" required autocomplete="company" />
                            </div>
                    ...
                    <div class="col-md-4 mt-4">
                        <div class="list-group">
                          <a href="{{route('user.account.index')}}" class="list-group-item list-group-item-action active">
                            Edit Account
                          </a>
                          <a href="{{route('user.account.profile.view')}}" class="list-group-item list-group-item-action">Account Privacy</a>
                        </div>
                    </div>
...
<script src="{{asset('assets/extra-libs/input-tel/js/intlTelInput.min.js')}}"></script>
 <script>
    ...
    $(document).on('click', "#account-update-btn", function() {
        ...
        let url = "{{route('user.account.update', ['id' => ':id'])}}";
