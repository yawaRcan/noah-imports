...
<div class="modal fade" id="ni-payment-change-modal" tabindex="-1" aria-labelledby="ni-payment-change-modal" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header d-flex align-items-center">
                <h4 class="modal-title" id="paymentReceiptStatus">Payment Receipt</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
...
<!-- Add modal content -->
<div class="modal fade" id="ni-payment-status-modal" tabindex="-1" aria-labelledby="ni-payment-change-status-modal" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header d-flex align-items-center">
                <h4 class="modal-title" id="paymenttStatusHeading">Add Payment Reciept</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body" id="payment-status-change-body">
...
<div class="modal fade" id="receipt-modal" tabindex="-1" aria-labelledby="credit-debit-modal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header d-flex align-items-center">
                <h4 class="modal-title"> Add Payment Invoice</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
...
<script>
    ...
    $(document).on('click', ".ni-payment-add-invoice", function() {
       
        let id = $(this).data("parcel-id");
    
        let url = "{{route('user.parcel.addPaymentInvoice',['id' => ':id'])}}";
        url = url.replace(':id', id);
        $('#paymenttStatusHeading').text('Add Payment Receipt')
        getHtmlAjax(url, "#ni-payment-status-modal", "#payment-status-change-body")
    })
    ...
    $(document).on('click', ".ni-paymentstatus-show-modal", function() {
        let id = $(this).data("parcel-id");
        let url = "{{route('user.parcel.getPaymentStatusHtml',['id' => ':id'])}}";
        url = url.replace(':id', id);
        // Function to get html of Payment Data
        $('#paymenttStatusHeading').text('Payment Receipt')
        getHtmlAjax(url, "#ni-payment-status-modal", "#payment-status-change-body")
    })
