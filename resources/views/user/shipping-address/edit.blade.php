                ...
                <div class="card-body">
                    <form class="form-horizontal" action="javascript:void(0)" id="shipping-update-form">
                        ...
                        <div class="input-group mb-3">
                          ...
                          <select class="form-control select2" name="country_id" style="width: 90%;">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input class="form-control" id="crib" type="text" name="crib" value="{{$shippingAddress->crib}}" autocomplete="crib" />
                        </div>
...
<script src="{{asset('assets/extra-libs/input-tel/js/intlTelInput.min.js')}}"></script>
 <script>
    ...
    $(document).on('click', "#shipping-update-btn", function() {
        ...
        let url = "{{route('user.shipping-address.update', ['id' => ':id'])}}";
