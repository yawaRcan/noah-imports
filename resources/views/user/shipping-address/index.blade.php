...
<div class="row page-titles">
    <div class="col-md-5 col-12 align-self-center">
        <h3 class="text-themecolor mb-0">Shipper Adresses</h3>
        <ol class="breadcrumb mb-0 p-0 bg-transparent">
            <li class="breadcrumb-item"><a href="javascript:void(0)">Account</a></li>
            <li class="breadcrumb-item active">Shipper Address</li>
        </ol>
    </div>
                ...
                <div class="border-bottom title-part-padding">
                    <div class="row">
                        ...
                        <div class="col-6 text-end">
                            <a href="{{route('user.shipping-address.create')}}" class="btn btn-light-info text-info font-weight-medium waves-effect">Add</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                                ...
                                <div class="card-body"> 
                                    ...
                                    <div class="row">
                                        <div class="col-6 text-start">
                                            <a href="{{route('user.shipping-address.edit', ['id' => $shippingAddress->id])}}" style="font-size:20px">
...
<script>
    $(document).on('click', ".shipping-data-delete", function() {
        ...
        let url = "{{route('user.shipping-address.destroy',['id' => ':id'])}}";
