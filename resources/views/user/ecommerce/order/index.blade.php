                ...
                <div class="border-bottom title-part-padding">
                    <div class="row">
                        ...
                        <div class="col-6 text-end">
                            <a href="{{route('online-store.index')}}" class="btn btn-light-info text-info font-weight-medium waves-effect">Create Order</a>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function table(params = null) { 
        ...
        table = $('.data-table').DataTable({
            ...
            destroy: true,
            stateSave: true,
            ajax: "{{route('user.ec-order.data')}}?status="+ status ,
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex'
                },
    ...
    $(document).on('click', ".ni-payment-show-modal", function() {
        ...
        let url = "{{route('user.ec-order.getPaymentHtml',['id' => ':id'])}}";
