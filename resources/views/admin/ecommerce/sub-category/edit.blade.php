<form class="form-horizontal" id="category-edit-form" action="javascript:void(0)">
    @csrf
    <div class="mb-3">
        <label>Select Category</label>
        <select name="category_id" id="ni-category-id" class="select2 form-control custom-select" style="width: 90%;">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="title" value="{{$Category->title}}" placeholder="Write category title">
    </div>
    <div class="mb-3">
        ...
        <div class="input-group mb-3">
            ...
            <textarea class="form-control" name="category_sum" id="ni-category-sum">{{$Category->summary}}</textarea>
        </div>
    </div>
    <div class="col-md-12">
    ...
    <div class="col-12" id="ni-category-file-append">
        @if($Category->photo != 'upload.png')
        <div class="text-start p-3 img-round">
            <img class="nl-exship-category-add-preview" src="{{asset('storage/assets/category')}}/{{$Category->photo}}" width="450" height="300" />
        </div>
        @endif
    </div>
    <div class=" text-end">
        <button type="submit" class="btn btn-light-success text-success font-weight-medium waves-effect" id="category-edit-button" data-category-id="{{$Category->id}}">Add</button>
    </div>
</form>
