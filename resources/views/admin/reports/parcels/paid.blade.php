...
<div class="row page-titles">
    <div class="col-md-5 col-12 align-self-center">
        ...
        <ol class="breadcrumb mb-0 p-0 bg-transparent">
            ...
            <li class="breadcrumb-item active">Paid Parcels</li>
        </ol>
    </div>
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="border-bottom title-part-padding">
                    <div class="row">
                        <div class="col-6">
                            <h4 class="card-title mb-0">Paid Parcels</h4>
                        </div>
                        <div class="col-6 text-end">
                            <form method="GET" id="paid_parcels_form" class="form-inline" action="{{route('reports.parcels.paid')}}">
