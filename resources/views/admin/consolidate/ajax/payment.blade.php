<form id="payment-form" action="javascript:void(0)" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <img src="{{asset('storage/assets/payment')}}/{{$payment->payment_receipt}}" style="width: 30%;" class="img-fluid mx-auto d-block" alt="">
            @else
...
<script>
    ...
    $("#update-payment").on('click', function(e) {
        e.stopPropagation();
        let url = "{{route('consolidate.paymentStatus.update')}}";
