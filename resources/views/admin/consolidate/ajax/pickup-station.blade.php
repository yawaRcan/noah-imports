                 ...
                 <div class="row">
                     <div class="col-6 text-start">
                         <div class="form-check form-check-inline">
                            @if(isset($consolidate->pickup_station_id))
                            <input class="form-check-input primary check-outline outline-primary" @if($consolidate->pickup_station_id == $pickUp->id) checked @endif type="radio" name="radio-pickup-station" id="primary-outline-radio" value="{{$pickUp->id}}">
                             @else
