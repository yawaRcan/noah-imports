        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="border-bottom title-part-padding">
                    <div class="row">
                        <div class="col-6">
                            <h4 class="card-title mb-0">Add Pickup Station</h4>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="javascript:void(0)" id="pickup-add-form">
                        @csrf
                        ...
                        <div class="form-group mb-3">
                            <input class="form-control form-control-prepended" id="contact_no" type="tel" />
                        </div>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input class="form-control" id="email" type="text" name="address" :value="old('address')" autocomplete="address" />
                        </div>
                        ...
                        <div class="d-flex align-items-stretch">
                            <button type="button" id="pickup-add-button" class="btn btn-success">Save</button>
                        </div>
                    </form>
...
<script src="{{asset('assets/extra-libs/input-tel/js/intlTelInput.min.js')}}"></script>
 <script>
    ...
    $(document).on('click', "#pickup-add-button", function() {

        let url = "{{route('pickup-station.store')}}";
        let formId = "#pickup-add-form";
        let type = "POST";
