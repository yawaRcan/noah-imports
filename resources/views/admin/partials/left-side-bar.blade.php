            ...
            <ul id="sidebarnav">
                ...
                @endif </span></a>
                    <ul aria-expanded="false" class="collapse  first-level">
                        ...
                        <li class="sidebar-item"><a href="{{route('purchasing.pending.order')}}" class="sidebar-link"><span class="mdi mdi-lan-pending"></span><span class="hide-menu">Pending Orders</span></a></li>
