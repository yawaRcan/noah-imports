                        ...
                        <div class="col-md-12">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select name="delivery_method" id="ni-delivery-method" class="select2 form-control custom-select" style="width: 90%;">
                                    ...
                                    <option value="1" @if( $parcels->delivery_method == 1 ) selected @endif >Pickup Station</option>
                                    <option value="0" @if( $parcels->delivery_method == 0 ) selected @endif >Door Step</option>
                                </select>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select name="import_duties" id="ni-import-duties-id" class="select2 form-control custom-select" style="width: 90%;">
