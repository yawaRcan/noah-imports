        ...
        $(function() {
            function setPrintOptions() {
                var printOptions = {
                    ...
                    pages: {
                        from: 1,
                        to: 1 // Specify the page range to print
                    },
                    layout: {
                        portrait: true // Set landscape orientation
                    },
                    color: true, // Enable color printing
                    background: true, // Enable printing background graphics 
                }; 

                // Apply the print options
                window.document.execCommand('print', false, printOptions);
            }
            $(".print-preview").on('click', function() {
                // Get the person's name
                var personName = "Tracking";

                // Format the date as desired (e.g., "YYYY-MM-DD")
                var waybill = "{{$invoice->waybill ?? 'N/A'}}";

                // Set the print file name
                var printFileName = personName + '-' + waybill;
                ...
                // return $("#page-wrap").printThis(printOptions);
            });
        });
    </script>
