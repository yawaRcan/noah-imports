<form class="form-horizontal" method="POST" id="ni-sender-address-add-form" action="javascript:void(0)">
    @csrf
    ...
    <div class="input-group mb-3">
        ...
        <input id="first_name" class="form-control" type="text" name="first_name" value="" autocomplete="first_name" val />
    ...
    <div class="input-group mb-3">
        ...
        <input id="last_name" class="form-control" type="text" name="last_name" value="" autocomplete="last_name" />
    ...
    <div class="input-group mb-3">
        ...
        <input class="form-control" id="email" type="email" name="email" value="" autocomplete="email" />
    </div>
    ...
    <div class="input-group mb-3">
        ...
        <input class="form-control form-control-prepended" name="contact_no" id="contact_no" type="tel" value="" />
    </div>

    <input type="hidden" name="initial_country" id="initial_country" value="">
    <input type="hidden" name="country_code" id="country_code" value="">
    <input type="hidden" name="phone" id="phone_complete" value="">

    <label for="tb-remail">Address</label>
    <div class="input-group mb-3">
        <span class="input-group-text fa fa-address-card"></span>
        <input class="form-control" id="email" type="text" name="address" value="" autocomplete="address" />
    </div>
    ...
    <div class="input-group mb-3">
      ...
      <!--country-select-->
      <select class="form-control country-select" name="country_id" style="width: 94.5%;">
    ...
    <div class="input-group mb-3">
        <span class="input-group-text fa fa-flag"></span>
        <input class="form-control" id="state" type="text" name="state" value="" autocomplete="state" />
    </div>
    <label for="tb-remail">City</label>
    <div class="input-group mb-3">
        <span class="input-group-text mdi mdi-city"></span>
        <input class="form-control" id="city" type="text" name="city" value="" autocomplete="city" />
    </div>
    <label for="tb-remail">ZipCode</label>
    <div class="input-group mb-3">
        <span class="input-group-text mdi mdi-code-string"></span>
        <input class="form-control" id="zipcode" type="text" name="zipcode" value="" autocomplete="zipcode" />
    </div>

    <div class="d-flex align-items-stretch">
        <button type="button" class="btn btn-success"  id="ni-sender-address-add-btn">Save</button>
    </div>
</form>
...
<script>
    ...
    var countryIdToCodeMap = {!! json_encode($countryCodes) !!};
     ...
     var contact = intlTelInput(inputJquery, {
         ...
         initialCountry: "{{$senderAddress->initial_country ?? 'auto'}}",
