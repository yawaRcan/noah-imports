...
<div class="row page-titles">
    <div class="col-md-5 col-12 align-self-center">
        ...
        <ol class="breadcrumb mb-0 p-0 bg-transparent">
            ...
            <li class="breadcrumb-item active"><a href="{{route('parcel.show',\Request::segment(4))}}">View Shipment</a></li>
        </ol>
    </div>
...
<div class="container-fluid">
    @if ($parcel->parcelStatus->slug == 'in-transit-to-be-delivered')
    <div class="text-end">
        <a href="{{route('parcel.delivery.recieve',['id' => $parcel->id])}}" target="_blank" class="btn btn-primary">Deliver Shipment</a>
    </div>
    @endif
    <div class="row mt-3">
        <div class="col-12">
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-4">
                        <div class="col-12 col-sm-6 col-md-4">
                            ...
                            <p> <span class="card-text">{{$parcel->amount_total ? 'ƒ '.number_format($parcel->amount_total, 2).' ANG' : 'ƒ 0.00 ANG'}}</span></p>
                        </div>
                        <div class="col-12 col-sm-6 col-md-4">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    @if($parcel->parcelImage->count()>0)
                                    <td><img style="width:50px;" src="{{ asset('storage/assets/parcel')}}/{{$parcel->parcelImage[0]->hash_name}}"  alt="..."></td>
                                    @else
                                     <td><img style="width:50px;" src="{{ asset('storage/assets/icons/default.png')}}"  alt="..."></td>
                                    @endif
    ...
    <div class="row mt-3">
        <div class="col-12">
            <div class="card card-hover">
                <div class="card-header">
                    <h4 class="mb-0 text-dark">Parcel Delivery information</h4>
                </div>
                <div class="card-body">
                    <div class="row mt-4">
                        <div class="col-12 col-sm-6 col-md-4">
                            <p class="fw-bold">Delivery Date</p>
                            @if($parcel->parcelDeliveryInfo!=null)
                            <p> <span class="card-text">{{$parcel->parcelDeliveryInfo->delivery_date ?? 'N/A'}}</span></p>
                            @endif
                        </div>
                        <div class="col-12 col-sm-6 col-md-4">
                            <p class="fw-bold">Delivered By</p>
                            @if($parcel->parcelDeliveryInfo!=null)
                            <p> <span class="card-text">{{$parcel->parcelDeliveryInfo->deliveredBy ? $parcel->parcelDeliveryInfo->deliveredBy->first_name.' '.$parcel->parcelDeliveryInfo->deliveredBy->last_name : 'N/A'}}</span></p>
                            @endif
                        </div>
                        <div class="col-12 col-sm-6 col-md-4">
                            <p class="fw-bold">Recieved By</p>
                            @if($parcel->parcelDeliveryInfo!=null)
                            <p> <span class="card-text">{{$parcel->parcelDeliveryInfo->reciever_name ?? 'N/A'}}</span></p>
                            @endif
                        </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-12 col-sm-6 col-md-4">
                            <p class="fw-bold">Sender Signature</p>
                            @if(isset($parcel->parcelDeliveryInfo->signature))
                                <p> <span class="card-text"><img class="nl-exship-file-edit-preview" src="{{asset('storage/assets/signatures')}}/{{$parcel->parcelDeliveryInfo->signature}}" width="150" /></span></p>
                            @else
                                <p> <span class="card-text">N/A</span></p>
                            @endif
                            
                        </div>
                        <div class="col-12 col-sm-6 col-md-4">
                            <p class="fw-bold">Photo left</p>
                            @if(isset($parcel->parcelDeliveryInfo->parcel_image))
                                <p> <span class="card-text"><img class="nl-exship-file-edit-preview" src="{{asset('storage/assets/parcelDelivery')}}/{{$parcel->parcelDeliveryInfo->parcel_image}}" width="200"/></span></p>
                            @else
                                <p> <span class="card-text">N/A</span></p>
                            @endif
    ...
    <div class="row mt-3">
        <div class="col-md-4 col-sm-12">
            <div class="card card-hover">
                ...
                <div class="card-body" style="height:250px">
                    <!-- <p class="card-text">Origin / Destination / Delivery Address : <span class="fw-bold">{{$parcel->sender->address ?? 'N/A'}}</span></p> -->

                    <p class="card-text">Name & Last Name : <span class="fw-bold">{{$parcel->sender->first_name ?? 'N/A'}} {{$parcel->sender->last_name ?? 'N/A'}}</span></p>
        ...
        <div class="col-md-4 col-sm-12">
            <div class="card card-hover">
                ...
                <div class="card-body" style="height:250px">
                    <!-- <p class="card-text">Origin / Destination / Delivery Address : <span class="fw-bold">{{$parcel->sender->address ?? 'N/A'}}</span></p> -->
                    <p class="card-text">Name & Last Name : <span class="fw-bold">{{$parcel->branch->name ?? 'N/A'}} {{$parcel->branch->last_name ?? 'N/A'}}</span></p>
        ...
        <div class="col-md-4 col-sm-12">
            <div class="card card-hover">
                ...
                <div class="card-body" style="height:250px">
                    <p class="card-text">Name & Last Name  : <span class="fw-bold">{{$parcel->reciever->first_name ?? 'N/A'}} {{$parcel->reciever->last_name ?? 'N/A'}}</span></p>
...
<script>
    ...
    $(document).on('click', ".ni-show-images", function() {
        ...
        let url = "{{route('parcel.imagesGet',['id' => ':id'])}}";
    ...
    $(document).on('click', "#parcel-edit-button", function() {
        let id = $(this).data("parcel-id");
        let url = "{{route('parcel.update',['id' => ':id'])}}";
        url = url.replace(':id', id);
