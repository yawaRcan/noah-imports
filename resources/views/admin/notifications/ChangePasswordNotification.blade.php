<a href="{{route('account.profile.view')}}" data-notification-id="{{$notification->id}}" class="ni-notification-click-read message-item d-flex align-items-center border-bottom px-3 py-2">
