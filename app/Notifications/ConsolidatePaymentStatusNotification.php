...
class ConsolidatePaymentStatusNotification extends Notification
{
    ...
    public function __construct(EmailTemplate $template = null , $shortCodes = [],Consolidate $consolidate = null)
    {
