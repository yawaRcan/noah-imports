...
class ShippingCalculatorController extends Controller
{
    ...
    function index()
    {
        return view('user.shipping-calculator.index');
    }
    ...
    function store(Request $request)
    {
        ...
        if ($request->freight_type == 'air-freight') {
            $html = view('user.shipping-calculator.ajax.air-calculate', compact('total'))->render();
        } else {
            $html = view('user.shipping-calculator.ajax.sea-calculate', compact('total'))->render();
        }
