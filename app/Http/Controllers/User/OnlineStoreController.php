...
class OnlineStoreController extends Controller
{
    ...
    {
        $carts = EcommerceCart::where('user_id', Auth::user()->id)->where('order_id', null)->get(); 

        $this->products =  DB::table('products')
        ->join('ecommerce_carts', 'products.id', '=', 'ecommerce_carts.product_id')
        ->select('ecommerce_carts.currency_id','ecommerce_carts.price',
        'ecommerce_carts.quantity','products.shipping_price','products.tax')
        ->where('ecommerce_carts.user_id', Auth::user()->id)
        ...
        return view('user.ecommerce.online-store.index', compact('products', 'carts','paymentMethods','calc'));
    }
    ...
    { 
        ...
        $already_cart = EcommerceCart::where('user_id', Auth::user()->id)->where('order_id', null)->where('product_id', $product->id)->first();
        if ($already_cart) {
        ...
        $cartView = view('user.ecommerce.online-store.cart', compact('carts','calc','paymentMethods'))->render(); 
    ...
    public function cartDelete($id)
    {
        ...
        if ($cart) {
            ...
            $cartView = view('user.ecommerce.online-store.cart', compact('carts','calc'))->render();
    ...
    public function show(string $id)
    {
        ...
        return view('user.ecommerce.product.show', ['product' => $product]);
    }
