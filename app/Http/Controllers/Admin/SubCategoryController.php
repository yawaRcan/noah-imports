...
class SubCategoryController extends Controller
{
    ...
    {
        return view('admin.ecommerce.sub-category.index');
    }
    ...
    {
        return view('admin.ecommerce.sub-category.add');
    }
    ...
    public function store(CreateRequest $request)
    {
        ...
        $Category->category_id = (isset($request->category_id)) ? $request->category_id  : 1;
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.ecommerce.sub-category.edit', ['Category' => $Category]);
    }
