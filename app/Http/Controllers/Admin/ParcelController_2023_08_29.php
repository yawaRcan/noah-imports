...
class ParcelController extends Controller
{
    ...
    public function index()
    {
        ...
        $drafted = null;
        $title = 'All Parcels';
        return view('admin.parcel.index', ['status' => $config, 'drafted' => $drafted, 'title' => $title]);
    }
    ...
    public function pendingParcels()
    {
        ...
        return view('admin.parcel.index', ['status' => $config, 'drafted' => null, 'title' => $title]);
    }
    ...
    public function draftedParcels()
    {
        ...
        return view('admin.parcel.index', ['status' => null, 'drafted' => $drafted, 'title' => $title]);
    }
    ...
    public function getParcelTracking($id)
    {
        ...
        return view('admin.parcel.tracking', compact('onlineTracking', 'lastIndex', 'onlineStatuses', 'onlineStatusesExceptions', 'statusValue', 'parcel', 'statuses'));
    }
    ...
    public function data(Request $request)
    {
        ...
        return Datatables::of($data)
            ...
            ->addColumn('action', function ($row) {
                $actionBtn = '<div class="dropdown dropstart">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="margin: 0px;">
                        ...
                        <li><a class="dropdown-item ni-payment-show-modal" href="javascript:void(0)" data-parcel-id="' . $row->id . '">View Reciept</a></li>
            ...
            ->rawColumns(['action', 'created_at', 'status', 'invoice_status', 'payment', 'amount', 'description', 'destination', 'reciever','sender', 'origin' , 'invoice', 'checkbox'])
            ->make(true);
    }
    ...
    public function archivedParcels(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            if (isset($request->user_id) && $request->user_id != '' && $request->user_id != null) {
                ...
                $data = Parcel::whereNotIn('id', $ids)->where(['payment_status_id' => 2,'parcel_status_id' => 5])->get();
            }
